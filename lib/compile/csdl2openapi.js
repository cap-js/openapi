...
const { preProcess: preprocessUtils, getVocabularies: getVocabulariesUtil } = require('./preprocessing');
// Import OpenAPI info and extensions utilities  
const { getInfo: getInfoUtil, getExternalDoc: getExternalDocUtil, getShortText: getShortTextUtil, getExtensions: getExtensionsUtil, getResourceDiagram: getResourceDiagramUtil } = require('./openapi-info');
...
module.exports.csdl2openapi = function (
    ...
    function getExtensions(csdl, level) {
        // Delegate to modular OpenAPI info utility
        return getExtensionsUtil(csdl, level);
    }
    ...
    function preProcess(csdl, boundOverloads, derivedTypes, alias, namespace, namespaceUrl, voc) {
        // Delegate to modular preprocessing utility
        return preprocessUtils(csdl, boundOverloads, derivedTypes, alias, namespace, namespaceUrl, voc);
    }
    ...
    function getVocabularies(voc, alias) {
        // Delegate to modular preprocessing utility
        return getVocabulariesUtil(voc, alias);
    }
    ...
    function getInfo(csdl, entityContainer) {
        // Delegate to modular OpenAPI info utility
        return getInfoUtil(csdl, entityContainer, voc, diagram, namespace);
    }
    ...
    function getExternalDoc(csdl) {
        // Delegate to modular OpenAPI info utility
        return getExternalDocUtil(csdl);
    }
    ...
    function getResourceDiagram(csdl, entityContainer) {
        // Delegate to modular OpenAPI info utility
        return getResourceDiagramUtil(csdl, entityContainer, namespace);
    }
    ...
    function getShortText(csdl, entityContainer) {
        // Delegate to modular OpenAPI info utility
        return getShortTextUtil(csdl, entityContainer, voc);
    }
