    ...
    function operationRead({ pathItem, element, name, sourceName, targetName, target, level, restrictions, byKey, nonExpandable }) {
        ...
        if (readable) {
            ...
            if (collection) {
                ...
                optionSkiptoken(operation.parameters, target);
...
see [Expand](http://docs.oasis-open.org/odata/odata/v4.01/odata-v4.01-part1-protocol.html#sec_SystemQueryOptionexpand)',
    ...
    /**
     * Add parameter for query option $skiptoken
     * @param {Array} parameters Array of parameters to augment
     * @param {null | TargetRestrictions} target Target container child of path
     */
    function optionSkiptoken(parameters, target) {
        const supported = target == null || target[meta.voc.Capabilities.SkipTokenSupported] !== false;
    ...
    */
    ...
    function getParameters() {
        const param = {
            ...
            skiptoken: {
                name: `${queryOptionPrefix}skiptoken`,
                in: 'query',
                description: 'Paging - Skip token, see [Server-driven Paging](http://docs.oasis-open.org/odata/odata/v4.01/odata-v4.01-part1-protocol.html#sec_ServerDrivenPaging)',
                schema: {
                    type: 'string'
                }
            },
