...
const propertyUtil = require('./property-util');const pluralize = require('pluralize')
...
module.exports.csdl2openapi = function (
    ...
    const { isNavBackReference, isNavWritable, isScalarReadOnly, isScalarWritable } = propertyUtil(meta);
    ...
    function schemasForStructuredType({ schemas, qualifier, name, type, suffix }) {
        ...
        Object.keys(properties).forEach(iName => {
            ...
            if (property.$Kind == 'NavigationProperty') {
                if (!isNavBackReference(property)) {
