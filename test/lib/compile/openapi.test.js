...
service CatalogService {
  ...
  test('options: url', () => {
    ...
    assert.strictEqual(openapi.info.description, "Use the Core.LongDescription or Core.Description annotation on your CDS service to provide a meaningful description.")
